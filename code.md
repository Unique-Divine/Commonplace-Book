...
* [Data Structures & Algorithms (DSA)](code.md#data-structures--algorithms-dsa)
  * [List-Based Collections](code.md#list-based-collections)
    * [Arrays and Python Lists](code.md#arrays-and-python-lists)
    * [Linked lists](code.md#linked-lists)
    * [Stacks](code.md#stacks)
    * [Queues](code.md#queues)
  * [Trees](code.md#trees)
    * [Binary Trees](code.md#binary-trees)
    * [Binary Search Tree (BST)](code.md#binary-search-tree-bst)
  * [Searching and Sorting](code.md#searching-and-sorting)
    * [Binary search](code.md#binary-search)
* [Python](code.md#python)
  * [Standard Library](code.md#standard-library)
    * [Reading and Writing Files](code.md#reading-and-writing-files)
    * [HTTP Requests](code.md#http-requests)
    * [Functools](code.md#functools)
  * [Writing Tests](code.md#writing-tests)
    * [Pytest Mock](code.md#pytest-mock)
  * [Working with Databases](code.md#working-with-databases)
    * [MongoDB (pymongo)](code.md#mongodb-pymongo)
  * [Object-Oriented Programming (OOP)](code.md#object-oriented-programming-oop)
    * [Data classes](code.md#data-classes)
    * [Prefer composition over inheritance](code.md#prefer-composition-over-inheritance)
    * [`NamedTuple` and `TypedDict`](code.md#namedtuple-and-typeddict)
  * [Miscellaneous](code.md#miscellaneous)
* [Databases, SQL, DBMS](code.md#databases-sql-dbms)
  * [Database Crash Course](code.md#database-crash-course)
* [Web development](code.md#web-development)
  * [Hugo Web Design](code.md#hugo-web-design)
  * [HTTP, TCP, IP](code.md#http-tcp-ip)
  * [HTML, CSS](code.md#html-css)
* [Git](code.md#git)
  * [Fundamental Concepts](code.md#fundamental-concepts)
  * [Branching](code.md#branching)
  * [Special Topics](code.md#special-topics)
* [Misc.](code.md#misc)
  * [C++](code.md#c)
  * [Design Patterns](code.md#design-patterns)
...
* [C header files](https://www.tutorialspoint.com/cprogramming/c\_header\_files.htm)
